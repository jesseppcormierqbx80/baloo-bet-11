...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-170356ed');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-170356ed');}
...
function clearFlash(){dieView.classList.remove('rl-win-170356ed');dieView.classList.remove('rl-lose-170356ed');if(frameEl){frameEl.classList.remove('rl-win-170356ed');frameEl.classList.remove('rl-lose-170356ed');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-170356ed');if(frameEl){frameEl.classList.add('rl-win-170356ed');}}else{dieView.classList.add('rl-lose-170356ed');if(frameEl){frameEl.classList.add('rl-lose-170356ed');}}
...
var brandEl=document.querySelector('.rl-brand-170356ed');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
